...
p = re.compile('/qq_33230935/article/details/........')

# 自己的博客主页
url = "http://blog.csdn.net/qq_33230935"
...
for index, page in enumerate(mypages):
    if index < 5:
        continue
    brushNum = random.randint(200, 400)
    for j in range(brushNum):
        try:
            ...
            time.sleep(3)  # 出现错误，停几秒先
        time.sleep(random.uniform(0.5, 1))  # 正常停顿，以免服务器拒绝访问
